<x-perfect-scrollbar as="nav" aria-label="main" class="flex flex-col flex-1 gap-4 px-3">
    ...
    <x-sidebar.dropdown title="Menu" :active="Str::startsWith(request()->route()->uri(), 'buttons')">
        ...
        <x-sidebar.sublink title="Kriteria" href="{{ route('criterias.index') }}"
            :active="request()->routeIs('criterias.index')" />
        <x-sidebar.sublink title="Alternatif" href="{{ route('alternatifs.index') }}"
            :active="request()->routeIs('alternatifs.index')" />
